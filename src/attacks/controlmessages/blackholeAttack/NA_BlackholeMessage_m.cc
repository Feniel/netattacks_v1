...
NA_BlackholeMessage::NA_BlackholeMessage(const char *name, int kind) : cMessage(name,kind)
{
    ...
    this->blackholeAttackProbability_var = 0;
    this->numHops_var = 0;
}
...
void NA_BlackholeMessage::copy(const NA_BlackholeMessage& other)
{
    ...
    this->blackholeAttackProbability_var = other.blackholeAttackProbability_var;
...
void NA_BlackholeMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->blackholeAttackProbability_var);
...
void NA_BlackholeMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->blackholeAttackProbability_var);
    doUnpacking(b,this->seqnoAdded_var);
    doUnpacking(b,this->numHops_var);
}

bool NA_BlackholeMessage::getSinkOnlyWhenRouteInTable() const
{
    return dropOnlyWhenRouteInTable_var;
}

void NA_BlackholeMessage::setSinkOnlyWhenRouteInTable(bool dropOnlyWhenRouteInTable)
{
    this->dropOnlyWhenRouteInTable_var = dropOnlyWhenRouteInTable;
}

double NA_BlackholeMessage::getBlackholeAttackProbability() const
{
    return blackholeAttackProbability_var;
}

void NA_BlackholeMessage::setBlackholeAttackProbability(double blackholeAttackProbability)
{
    this->blackholeAttackProbability_var = blackholeAttackProbability;
}
...
int NA_BlackholeMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "dropOnlyWhenRouteInTable")==0) return base+0;
    if (fieldName[0]=='s' && strcmp(fieldName, "blackholeAttackProbability")==0) return base+1;
